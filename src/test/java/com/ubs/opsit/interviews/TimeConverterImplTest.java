...
public class TimeConverterImplTest {
	...
	public void testEmptyTimeStringProvided() {
		timeConverter.convertTime("");
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testNullTimeProvided() {
		timeConverter.convertTime(null);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testTimeStringInIncorrectFormat() {
	...
	@Test
	public void testConvertStringToLocalTime() throws Exception {
		TimeConverterImpl instance = PowerMockito.spy(new TimeConverterImpl());
		
		Whitebox.invokeMethod(instance, "convertTimeStringToLocalTime", "24:00:00");
		
		PowerMockito.verifyPrivate(instance).invoke("convertTimeStringToLocalTime", "24:00:00");
	}
}
